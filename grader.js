...
if(require.main == module) {
    program
        ...
        .option('-u, --url <page_url>', 'Path to external index.html', 
            clone(assertUrlExists), HTMLFILE_DEFAULT)
        .parse(process.argv);

    var callback = function(checkJson) {
    ...
    if (program.file) {
      ...
      checkUrlFile(program.url, program.checks, callback);
    }
} else {
